...
### Fixed
- Restored the official `mcp-bridge` runtime, capability, and IPC identity, restoring drop-in compatibility with the official upstream distribution while retaining Hushlor coordinates.
